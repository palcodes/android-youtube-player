...
const namespace =
  "urn:x-cast:com.pierfrancescosoffritti.androidyoutubeplayer.chromecast.communication";
...
const senderMessagesDispatcher = new SenderMessagesDispatcher(
  communicationConstants,
  { onInitMessageReceived, ...youTubePlayer.getActions() }
);
...
function onInitMessageReceived(parsedCommunicationConstants) {
  ...
  } else youTubePlayer.restoreCommunication();
}
